...
let ChangeHousingComponent = class ChangeHousingComponent {
    ...
    save() {
        ...
        if (this.heroForm.valid) {
            ...
            this.newObj.request.requestTypeID = enums.RequestTypeId.ChangeHousing;
            ...
            //extraFiled 
            this.addUpdateExtraField(6, dateToDB);
            this.addUpdateExtraField(7, this.justification);
    ...
    bindData(data) {
        ...
        try {
            this.bsFromDate = new Date(this.getExtraFieldValue(6));
            this.justification = this.getExtraFieldValue(7);
        }
        catch (error) {
        }
    }
...
], ChangeHousingComponent.prototype, "heroForm", void 0);
__decorate([
    ViewChild('time', { static: false }),
    __metadata("design:type", Object)
], ChangeHousingComponent.prototype, "time2", void 0);
__decorate([
    ViewChild('FromDate', { static: true }),
    __metadata("design:type", ElementRef)
], ChangeHousingComponent.prototype, "FromDate", void 0);
__decorate([
    ViewChild(ActionBarComponent, { static: false }),
    __metadata("design:type", ActionBarComponent)
], ChangeHousingComponent.prototype, "actionBar", void 0);
ChangeHousingComponent = __decorate([
    Component({
        selector: 'app-changeHousing',
        templateUrl: './changeHousing.component.html',
        styleUrls: ['./changeHousing.component.scss']
    }),
...
export { ChangeHousingComponent };
//# sourceMappingURL=changeHousing.component.js.map