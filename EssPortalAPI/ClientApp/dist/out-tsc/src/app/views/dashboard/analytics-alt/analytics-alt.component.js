...
let AnalyticsAltComponent = class AnalyticsAltComponent {
    constructor(layout, snack) {
        this.layout = layout;
        this.snack = snack;
...
AnalyticsAltComponent = __decorate([
    Component({
...
export { AnalyticsAltComponent };
//# sourceMappingURL=analytics-alt.component.js.map