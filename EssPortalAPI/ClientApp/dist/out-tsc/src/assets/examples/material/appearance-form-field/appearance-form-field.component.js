...
let AppearanceFormFieldComponent = class AppearanceFormFieldComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
export { AppearanceFormFieldComponent };
//# sourceMappingURL=appearance-form-field.component.js.map