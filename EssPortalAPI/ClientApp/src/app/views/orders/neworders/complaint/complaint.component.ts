...
export class ComplaintComponent implements OnInit {
  ...
  save() {
    ...
    if (this.heroForm.valid) {
      ...
      //extraFiled 
      this.addUpdateExtraField(83, dateToDB);
      this.addUpdateExtraField(84, this.justification);
  ...
  bindData(data: any) {
    ...
    try {
      this.bsFromDate = this.helpersService.getDate(this.getExtraFieldValue(83));
      this.justification = this.getExtraFieldValue(84);
    }
    catch (error) {
