...
export class DashboardDarkComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
      setTimeout(() => {
        ...
        this.scack.open('Layout option changed to {sidebarColor: "dark-blue", topbarColor: "dark-blue", matTheme: "egret-dark-purple"};', 'OK', {duration: 6000})
      });
    ...
    ngOnDestroy() {
      setTimeout(() => {
        ...
        this.scack.open('Layout option changed {sidebarColor: "black", topbarColor: "white"};', 'OK', {duration: 6000})
