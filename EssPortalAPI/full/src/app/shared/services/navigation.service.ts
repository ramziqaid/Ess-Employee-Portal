...
export class NavigationService {
  ...
  iconMenu: IMenuItem[] = [
    ...
    },
    {
      ...
      type: "dropDown",
      tooltip: "Employee Orders",
      icon: "shopping_cart",
      state: "employeeorders",
      sub: [
        { name: "My Orders", state: "MyOrders" },
        { name: "Approval of Orders", state: "ApprovalOrders" },
        { name: "New Order", state: "NewOrders" },
      ]
    },
    {
      name: "Personal Info",
      ...
      state: "PersonalInfo",
      sub: [
        { name: "Personal Information", state: "Info" },
    ...
    },
    {
      ...
      sub: [
        ...
        { name: "Show Users", state: "User/AllUser" },
        { name: "Change Password", state: "ChangePassword" },
        { name: "Remove Role", state: "Assign/Role" },
        { name: "All Roles", state: "Assign/AllRole" }
      ]
    },
    {
      name: "INBOX",
