...
import { AdminAuthGuardService } from './shared/services/auth/adminAuthGuardService';
...
export const rootRouterConfig: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'employeeorders',
        loadChildren: () => import('./views/employeeorders/employeeorders.module').then(m => m.EmployeeordersModule),
        data: { title: 'Employee Orders', breadcrumb: 'employeeorders' },
        canLoad: [AuthGuard]
      },
      {
        path: 'PersonalInfo',
        loadChildren: () => import('./views/PersonalInfo/personalInfo.module').then(m => m.PersonalInfoModule),
        data: { title: 'Personal Info', breadcrumb: 'PersonalInfo' },
        canLoad: [AuthGuard]
      },
      {
        ...
        data: { title: 'Admin Area', breadcrumb: 'AdminArea' },
        canLoad: [AuthGuard],
      },
