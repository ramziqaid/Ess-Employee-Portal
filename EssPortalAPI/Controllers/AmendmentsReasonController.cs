...
//    public class AmendmentsReasonController : Controller
//    {

//        private readonly IAmendmentReasonRepository _amendmentReasonRepository;
//        public AmendmentsReasonController(IAmendmentReasonRepository amendmentReasonRepository)
//        {
//            _amendmentReasonRepository = amendmentReasonRepository;
//        }

//        [HttpGet]
//        public async Task<IEnumerable<AmendmentReason>> GetAmendment()
//        {
//            try
//            {
//                IEnumerable<AmendmentReason> obj = await _amendmentReasonRepository.GetAllAsyn();
//                return obj;
//            }
//            catch (Exception ex)
//            {
